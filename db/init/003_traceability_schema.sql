...
ALTER TABLE materials
    ADD COLUMN IF NOT EXISTS project_usage_count BIGINT NOT NULL DEFAULT 0,
    ADD COLUMN IF NOT EXISTS collection_usage_count BIGINT NOT NULL DEFAULT 0,
    ADD COLUMN IF NOT EXISTS source_type VARCHAR(40) NOT NULL DEFAULT 'USER_UPLOAD',
    ADD COLUMN IF NOT EXISTS source_note VARCHAR(500) DEFAULT '',
    ADD COLUMN IF NOT EXISTS ownership_type VARCHAR(40) NOT NULL DEFAULT 'PERSONAL',
    ...
    ADD COLUMN IF NOT EXISTS recycle_expire_at DATETIME NULL,
    ADD COLUMN IF NOT EXISTS original_title VARCHAR(255) NULL,
    ADD COLUMN IF NOT EXISTS original_preview_path VARCHAR(500) NULL;

ALTER TABLE project_material_rel
    ADD COLUMN IF NOT EXISTS added_by BIGINT NULL,
    ADD COLUMN IF NOT EXISTS added_at DATETIME NULL,
    ADD COLUMN IF NOT EXISTS source_type VARCHAR(40) NOT NULL DEFAULT 'DIRECT_BIND',
    ADD COLUMN IF NOT EXISTS source_note VARCHAR(500) DEFAULT '',
    ADD COLUMN IF NOT EXISTS material_owner_id BIGINT NULL,
    ADD COLUMN IF NOT EXISTS material_status VARCHAR(20) NOT NULL DEFAULT 'ACTIVE';
